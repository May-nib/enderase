...
function App() {
  ...
  return (
    <div className="font-sans ">
      ...
      <header className={`fixed w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-white shadow-md py-2' : 'bg-transparent py-4'}`}>
        <div className="container mx-auto px-4 md:px-6 flex justify-between items-center">
          <div className="flex items-center">
            ...
            <span className={`text-xl font-bold   ${isScrolled ? 'text-blue-800' : 'text-white'}`}>Enderase Research</span>
          </div>

          {/* Desktop Navigation */}
          <nav className="hidden md:flex space-x-8">
            <a href="#home" className={`text-blue-800 hover:text-blue-600 font-medium  ${isScrolled ? 'text-blue-800' : 'text-white'}`}>Home</a>
            <a href="#about" className={`text-blue-800 hover:text-blue-600 font-medium  ${isScrolled ? 'text-blue-800' : 'text-white'}`}>About</a>
            <a href="#services" className={`text-blue-800 hover:text-blue-600 font-medium  ${isScrolled ? 'text-blue-800' : 'text-white'}`}>Services</a>
            <a href="#it" className={`text-blue-800 hover:text-blue-600 font-medium  ${isScrolled ? 'text-blue-800' : 'text-white'}`}>IT Solutions</a>
            <a href="#contact" className={`text-blue-800 hover:text-blue-600 font-medium  ${isScrolled ? 'text-blue-800' : 'text-white'}`}>Contact</a>
          </nav>
      ...
      <main>
        {/* Hero Section */}
        <section id="home" className="pt-32 pb-20 md:pt-40 md:pb-28 bg-gradient-to-r from-blue-900 to-blue-300 text-white">
        ...
        <section id="about" className="py-20 bg-white">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-blue-800 mb-4">About Enderase Research Solutions</h2>
              <div className="h-1 w-20 bg-blue-200 mx-auto mb-6"></div>
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white rounded-xl shadow-md overflow-hidden transition-transform hover:-translate-y-2">
                ...
                <div className="p-6">
                  <div className="h-12 w-12 bg-blue-100 rounded-lg flex items-center justify-center text-blue-800 mb-4">
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                    </svg>
                  </div>
                  <h3 className="text-xl font-bold text-blue-800 mb-3">Ethics Consultation & Facilitation</h3>
              ...
              <div className="bg-white rounded-xl shadow-md overflow-hidden transition-transform hover:-translate-y-2">
                ...
                <div className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-blue-800 mb-3">Training in Research Ethics & GCP</h3>
                  <p className="text-gray-600">
              ...
              <div className="bg-white rounded-xl shadow-md overflow-hidden transition-transform hover:-translate-y-2">
                ...
                <div className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-blue-800 mb-3">Research Design & Implementation</h3>
                  <p className="text-gray-600">
        ...
        <section id="it" className="py-24 bg-gradient-to-r from-white via-blue-50 to-blue-50">
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-4xl mx-auto text-center mb-12">
              <div className="text-sm font-semibold text-blue-800 uppercase">IT Solution Services</div>
              <h2 className="text-3xl md:text-4xl font-bold text-blue-900 mt-3">Gelagle — Technology-Driven Review Platform</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8 items-start">
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                <h3 className="text-xl font-semibold text-blue-800 mb-3">Streamlined Submissions</h3>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                <h3 className="text-xl font-semibold text-blue-800 mb-3">Reviewer Workflows</h3>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                <h3 className="text-xl font-semibold text-blue-800 mb-3">Transparent Tracking</h3>
            ...
            <div className="mt-10 text-center">
              <a href="#contact" className="inline-block px-6 py-3 bg-blue-800 text-white rounded-lg font-semibold hover:bg-blue-700 transition">Request a Demo</a>
              <a href="#" className="inline-block ml-3 px-6 py-3 border border-blue-800 text-blue-800 rounded-lg font-semibold hover:bg-blue-50 transition">Learn about Gelagle (ገላግሌ)</a>
            </div>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="bg-gray-50 p-6 md:p-8 rounded-xl">
                <form className="space-y-6" onSubmit={handleSubmit}>
                  ...
                  <button type="submit" className="bg-blue-800 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition">Send Message</button>
                </form>
              </div>
            </div>
          </div>
